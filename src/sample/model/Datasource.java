...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\Downloads\\Udemy\\Java\\MasterClass\\MusicUI\\" + DB_NAME;
    ...
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " + TABLE_ARTIST_SONG_VIEW + " AS SELECT " +
            TABLE_ARTISTS + "." + COLUMN_ARTISTS_NAME + ", " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " AS " +
            COLUMN_SONG_ALBUM + ", " + TABLE_SONGS + "." + COLUMN_SONG_TRACK + ", " + TABLE_SONGS + "." + COLUMN_SONG_TITLE +
            " FROM " + TABLE_SONGS +
    ...
    public boolean updateArtistName( int id, String newName) {
        try {
            ...
            System.out.println("Update failes: " + e.getMessage());
            return false;
        }
    }
    ...
    public void insertSong(String title, String artist, String album, int track) throws SQLException {
        ...
        if (results.next()) {
            System.out.println("Exact song already exists on the same album.");
        } else {
